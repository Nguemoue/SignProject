...
@section('main')
    ...
    <div class="row">
        <div class="card mx-auto mt-2">
            <img src="{{ asset('storage/' . $categorieProduit->image) }}" alt="image de la categorie" class="img-fluid" />
            <div class="card-footer">
                Logo de la categorie
            </div>
        </div>
    </div>
    <hr>
    <div class="container">
        <div class="">
            ...
            <form enctype="multipart/form-data"
                action="{{ route('admin.categorieProduit.update', ['categorieProduit' => $categorieProduit->id]) }}"
                method="POST">
                @method('PUT')
                @csrf
                <div class="mb-3">
                    ...
                    <input id="nom" name="nom" type="text" class="form-control"
                        placeholder="entrez le nom de la categorie de produit" value="{{ $categorieProduit->nom }}" />
                </div>

                <div class="mb-3">
                    <label for="description">Description</label>
                    <textarea name="description" id="description" class="form-control">{{ $categorieProduit->description }}</textarea>
                </div>
                <div class="mb-3">
                    <label for="fileField" class="btn btn-secondary"> <span class="mdi mdi-image"></span> nouvelle
                        image</label>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-4" id="cropPhotoElementLabel">Edition de la photo</h1>
