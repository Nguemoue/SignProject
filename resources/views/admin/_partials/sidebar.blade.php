            ...
            <nav class="navbar p-0 fixed-top d-flex flex-row">
                <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
                    <a class="navbar-brand brand-logo-mini" href="home.php">
                        <span color="#ffffff">ADMININISTRATEUR</span>
                    </a>
                </div>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                                <div class="navbar-profile border">
                                    <span class=" mx-2 p-3">{{ auth('admin')->user()->nom }}</span>
                                    <img class="img-xs rounded-circle" src="{{ asset('storage/'.auth('admin')->user()->photo) }}" alt="">
